...
-Wl,--Map=lin.map -o lin.wasm -I ../arch/lkl/include ../lib/lib.a ../vmlinux.a initschedclasses.o hostwasm_main.c hostwasm_lklops.c initsyms.gen.c && ../../wabt/build/wasm2c --enable-threads -o lin.c lin.wasm
